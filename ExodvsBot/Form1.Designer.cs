...
namespace ExodvsBot
{
    public partial class Form1 : Form
    {
        ...
        private TextBox txtTelegramToekn;
...
╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═════╝  ╚═════╝ ╚══════╝";
            ...
            configLayout.SetColumnSpan(txtApiKey, 2);
            ...
            configLayout.SetColumnSpan(txtApiSecret, 2);

            // Telegram Token
            Label lblTelegramToken = new Label();
            lblTelegramToken.Text = "Telegram Token:";
            lblTelegramToken.ForeColor = Color.White;
            lblTelegramToken.TextAlign = ContentAlignment.MiddleLeft;
            lblTelegramToken.Dock = DockStyle.Fill;
            configLayout.Controls.Add(lblTelegramToken, 0, 2);

            txtTelegramToekn = new TextBox();
            txtTelegramToekn.Dock = DockStyle.Fill;
            txtTelegramToekn.BackColor = Color.FromArgb(44, 47, 51);
            txtTelegramToekn.ForeColor = Color.White;
            txtTelegramToekn.BorderStyle = BorderStyle.FixedSingle;
            configLayout.Controls.Add(txtTelegramToekn, 1, 2);
            configLayout.SetColumnSpan(txtTelegramToekn, 2);

            // Telegram Chat Id
            Label lblTelegramChatId = new Label();
            lblTelegramChatId.Text = "Telegram Chat Id:";
            lblTelegramChatId.ForeColor = Color.White;
            lblTelegramChatId.TextAlign = ContentAlignment.MiddleLeft;
            lblTelegramChatId.Dock = DockStyle.Fill;
            configLayout.Controls.Add(lblTelegramChatId, 0, 3);

            txtTelegramChatId = new TextBox();
            txtTelegramChatId.Dock = DockStyle.Fill;
            txtTelegramChatId.BackColor = Color.FromArgb(44, 47, 51);
            txtTelegramChatId.ForeColor = Color.White;
            txtTelegramChatId.BorderStyle = BorderStyle.FixedSingle;
            configLayout.Controls.Add(txtTelegramChatId, 1, 3);
            configLayout.SetColumnSpan(txtTelegramChatId, 2);
            ...
            configLayout.Controls.Add(lblKlineInterval, 0, 4);
            ...
            configLayout.Controls.Add(cmbKlineInterval, 1, 4);
            configLayout.SetColumnSpan(cmbKlineInterval, 2);
            ...
            configLayout.Controls.Add(lblStoploss, 0, 5);
            ...
            configLayout.Controls.Add(cmbStoploss, 1, 5);
            ...
            configLayout.Controls.Add(txtStoplossCustom, 2, 5);
            ...
            configLayout.Controls.Add(lblTakeProfit, 0, 6);
            ...
            configLayout.Controls.Add(cmbTakeProfit, 1, 6);
            ...
            configLayout.Controls.Add(txtTakeProfitCustom, 2, 6);
            ...
            configLayout.Controls.Add(lblBuyRSI, 0, 7);
            ...
            numBuyRSI.Value = 30;
            configLayout.Controls.Add(numBuyRSI, 1, 7);
            configLayout.SetColumnSpan(numBuyRSI, 2);
            ...
            configLayout.Controls.Add(lblSellRSI, 0, 8);
            ...
            numSellRSI.Value = 70;
            configLayout.Controls.Add(numSellRSI, 1, 8);
            configLayout.SetColumnSpan(numSellRSI, 2);
            ...
            configLayout.Controls.Add(buttonPanel, 0, 9);
        ...
        private async void btnStartBot_Click(object sender, EventArgs e)
        {
            ...
            var startSettingsDto = new StartSettingsDto()
            {
                ...
                txtTelegramChatId = txtTelegramChatId.Text,
                txtTelegramToken = txtTelegramToekn.Text,
